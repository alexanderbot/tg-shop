...
export default function FilterPanel({
  ...
  return (
    <div className="sticky top-0 z-20 glass-bg border-b border-[var(--tg-theme-secondary-bg-color,#f0f0f0)]">
      <div className="flex items-center gap-2 px-3 py-2.5 overflow-x-auto no-scrollbar">
        ...
        <div className="relative shrink-0" ref={menuRef}>
          <button
            ...
            className={`
              flex items-center gap-1 px-3 py-1.5 rounded-full text-[13px] font-semibold transition-all duration-200
              ${hasPriceFilter
                ? "bg-[var(--tg-theme-button-color,#f472b6)] text-[var(--tg-theme-button-text-color,#fff)] shadow-sm"
          ...
          {showPriceMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 rounded-xl overflow-hidden card-shadow-lg z-30 bg-[var(--tg-theme-bg-color,#fff)] border border-[var(--tg-theme-secondary-bg-color,#eee)] animate-scale-in origin-top-right">
